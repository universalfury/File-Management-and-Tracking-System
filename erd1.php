...
$p="SELECT count(status) as assgn from dak where ename='$ename' and status='new' and date between '$frm' and '$to' ";
$p1="SELECT * from dak where ename='$ename' and status='new' and date between '$frm' and '$to' ";
...
<h1 class="main">
  ...
  <button id ="acc" Name="acc" class="main accordion">Files enetered so far</button>
  <div class="panel">
   <p><a class="main">
