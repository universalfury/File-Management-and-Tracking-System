...
$p="SELECT count(status) as assgn from dak where ename='$ename' and status='assigned' ";
$p1="SELECT * from dak where ename='$ename' and status='assigned' ";
$result=mysqli_query($con,$p);
$result1=mysqli_query($con,$p1);
$row2=mysqli_fetch_assoc($result);
$q="SELECT count(status) as ret from dak where ename='$ename' and status='returned' ";
$q1="SELECT * from dak where ename='$ename' and status='returned' ";
$res=mysqli_query($con,$q);
$res1=mysqli_query($con,$q1);
$row3=mysqli_fetch_assoc($res);
$r="SELECT count(status) as pend from dak where ename='$ename' and status='pending' ";
$r1="SELECT * from dak where ename='$ename' and status='pending' ";
$re=mysqli_query($con,$r);
$re1=mysqli_query($con,$r1);
$row4=mysqli_fetch_assoc($re);
$s="SELECT count(status) as comp from dak where ename='$ename' and status='completed' ";
$s1="SELECT * from dak where ename='$ename' and status='completed' ";
...
<h1 class="main">
  ...
  <div class="panel">
   <p><a class="main">
	...
	<br>
	<p style="text-align:500px;font-size:140%;"><b> Number of files : <?php  echo"{$row4['pend']}"?></b></p>
	</p>
      <div class="row">
        <div class="col-md-10 bg-info border border-dark text-center">		
          <table class="table">
  ...
  <th>  <a href="#" onclick="exportTableToExcel('printTable5', 'members-data')"><br>Export TableTo Excel File</a></th>
  </div></table>
  </a></p></div>
   <script>
