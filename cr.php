...
$s="SELECT count(status) as newc from dak where status='new' ";
$sql="SELECT count(status) as pendc from dak where status='pending' or status='assigned' ";
$k="SELECT count(status) as retc from dak where status='completed' ";
$q="SELECT count(status) as compc from dak where status='returned' ";
$sq="SELECT * from dak where status='new' ";
$sq1="SELECT * from dak where status='returned' ";
$sq2="SELECT * from dak where status='completed' ";
...
//-->
  ...
  <h1 class="main">
    <b><br> Total Files under process so far:- </b>
  </h1>
  ...
  <div class="panel">
   <p><a class="main">
	...
	<br>
	<p style="text-align:350px;font-size:140%;"><b> Number of files : <?php  echo"{$row['newc']}"?></b> </p>
	</p>
      <div class="row">
  ...
  <p><a class="main">
	...
	<br>
	<p style="text-align:350px;font-size:140%;"> <b>Number of files :<?php  echo"{$row3['compc']}"?></b></p>
	</p>
      <div class="row">
        <div class="col-md-10 bg-info border border-dark text-center">
          <table class="table">
